...
Version  : 3.34.1
Release  : 17
URL      : https://download.gnome.org/sources/gnome-flashback/3.34/gnome-flashback-3.34.1.tar.xz
Source0  : https://download.gnome.org/sources/gnome-flashback/3.34/gnome-flashback-3.34.1.tar.xz
...
%prep
%setup -q -n gnome-flashback-3.34.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1570744101
