...
Source0  : https://download.gnome.org/sources/gnome-flashback/3.36/gnome-flashback-3.36.3.tar.xz
...
%prep
%setup -q -n gnome-flashback-3.36.3
cd %{_builddir}/gnome-flashback-3.36.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1588259909
...
cp %{_builddir}/gnome-flashback-3.36.3/COPYING %{buildroot}/usr/share/package-licenses/gnome-flashback/8624bcdae55baeef00cd11d5dfcfa60f68710a02
%make_install
