...
Source0  : https://download.gnome.org/sources/gnome-flashback/3.34/gnome-flashback-3.34.2.tar.xz
...
%prep
%setup -q -n gnome-flashback-3.34.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1572804335
...
cp %{_builddir}/gnome-flashback-3.34.2/COPYING %{buildroot}/usr/share/package-licenses/gnome-flashback/8624bcdae55baeef00cd11d5dfcfa60f68710a02
%make_install
