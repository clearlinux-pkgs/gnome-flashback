...
Version  : 3.38.0
Release  : 23
URL      : https://download.gnome.org/sources/gnome-flashback/3.38/gnome-flashback-3.38.0.tar.xz
Source0  : https://download.gnome.org/sources/gnome-flashback/3.38/gnome-flashback-3.38.0.tar.xz
...
%prep
%setup -q -n gnome-flashback-3.38.0
cd %{_builddir}/gnome-flashback-3.38.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1602803564
...
cp %{_builddir}/gnome-flashback-3.38.0/COPYING %{buildroot}/usr/share/package-licenses/gnome-flashback/8624bcdae55baeef00cd11d5dfcfa60f68710a02
%make_install
