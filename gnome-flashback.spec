...
Version  : 3.42.1
Release  : 26
URL      : https://download.gnome.org/sources/gnome-flashback/3.42/gnome-flashback-3.42.1.tar.xz
Source0  : https://download.gnome.org/sources/gnome-flashback/3.42/gnome-flashback-3.42.1.tar.xz
...
%prep
%setup -q -n gnome-flashback-3.42.1
cd %{_builddir}/gnome-flashback-3.42.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1638449888
...
cp %{_builddir}/gnome-flashback-3.42.1/COPYING %{buildroot}/usr/share/package-licenses/gnome-flashback/8624bcdae55baeef00cd11d5dfcfa60f68710a02
%make_install
