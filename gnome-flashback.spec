...
Version  : 3.26.0
Release  : 5
URL      : https://download.gnome.org/sources/gnome-flashback/3.26/gnome-flashback-3.26.0.tar.xz
Source0  : https://download.gnome.org/sources/gnome-flashback/3.26/gnome-flashback-3.26.0.tar.xz
...
%prep
%setup -q -n gnome-flashback-3.26.0
...
export LANG=C
export SOURCE_DATE_EPOCH=1507212411
